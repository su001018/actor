...
libs_softmmu=-lpixman-1 -lutil  -luuid  -L$(BUILD_DIR)/dtc/libfdt -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.5.0
PKGVERSION=
SRC_PATH=/home/test/workdir/code/actor/tools/qemu
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/test/workdir/code/actor/tools/qemu/build/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
